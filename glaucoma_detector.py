# -*- coding: utf-8 -*-
"""
单文件版本：UNet 视盘分割 + EfficientNet-B3 青光眼分类 + PyQt5 GUI
...
同一目录下需要：
- 384_unet.pth         # UNet 权重
- efficientnet.pth     # EfficientNet 分类权重
- welcome.jpeg         # 欢迎页背景（可选）
"""
...
class AnalyzePage(QWidget):
    ...
    def init_ui(self):
        ...
        top_label = QLabel("Please select a retinal fundus image for inspection\n"
