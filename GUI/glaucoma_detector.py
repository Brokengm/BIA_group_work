# -*- coding: utf-8 -*-
"""
Single-file version: UNet optic-disc segmentation + EfficientNet-B3 glaucoma classification + PyQt5 GUI
...
- 384_unet.pth         # UNet weights
- efficientnet.pth     # EfficientNet classifier weights
- welcome.jpeg         # Welcome screen background (optional)
"""
...
# =======================================================
# Part 3: UNet segmentation model
# =======================================================
...
# =======================================================
# Part 4: Image processing helpers
# =======================================================
...
def crop_optic_disc_region(rgb_image, optic_disc_mask):
    ...
    half_crop_size = 250  # Crop a 500x500 region around the disc center
...
def preprocess_fundus_image(image_path, unet_model, debug=False):
    """
    End-to-end preprocessing: input a raw fundus image and output a 384x384 optic-disc crop
    """
    pil_image = Image.open(image_path).convert("RGB")
...
# =======================================================
# Part 5: Classification model (EfficientNet-B3 + FC head)
# =======================================================
...
def get_unet_model():
    ...
    if _unet_instance is None:
        ...
        print("[INFO] UNet loaded successfully")
...
def get_effnet_model():
    ...
    if _effnet_instance is None:
        ...
        checkpoint = torch.load(EFFICIENTNET_WEIGHTS_PATH, map_location=DEVICE)
        if isinstance(checkpoint, dict) and "model_state_dict" in checkpoint:
            state = checkpoint["model_state_dict"]
        else:
            state = checkpoint
        ...
        print("[INFO] EfficientNet loaded successfully")

    return _effnet_instance


# =======================================================
# Part 6: Inference interface
# =======================================================
def predict_single_cropped_image_array(img_array: np.ndarray) -> dict:
    """
    Input: a pre-cropped 384x384x3 NumPy array
    Output: a dict containing prediction and probabilities
    """
...
def glaucoma_predict_pipeline(image_path: str) -> dict:
    """
    Public entrypoint used by the GUI
    Input: path to a raw fundus image
    Output: a dict containing prediction and probabilities
    """
...
# =======================================================
# Part 7: GUI — Welcome page + Analysis page + Main window
# =======================================================
...
class AnalyzePage(QWidget):
    ...
    def run_analysis(self):
        """
        Run glaucoma detection with the real models
        - Do not show demo placeholder text
        - Do not color-code risk levels
        - Render all results in black text
        """
